  ...
  return (
    <>
      <div className='py-5'>
        ...
        <div className='md:flex px-6 md:px-60 items-center justify-between'>
          <div className='md:flex justify-center items-center mx-4 md:mx-4 space-x-4 md:space-x-14'>
            ...
            <form className="px-3 md:flex-shrink-0">
              <select
                id="underline_select"
                className="block w-full md:w-auto px-4 py-3 text-xl font-barlow-condensed bg-transparent border-0 border-b-2 border-[#4fd64d] focus:outline-none focus:ring-0 focus:border-[#4fd64d] peer"
        ...
        {loading ? (
          <div className='flex flex-wrap justify-center'>{random.map(() => <CardSkeleton />)}</div>
        ) : (
